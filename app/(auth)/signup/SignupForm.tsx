...
const SignUpPage = () => {
  ...
  return (
    <div className="w-full h-full md:grid md:grid-cols-12 md:gap-[5%] px-6 sm:px-8 md:px-10 py-10">
     ...
     <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold text-center text-white mb-8 md:mb-0 md:col-span-5 flex items-center justify-center">
      ...
      {/* FORM */}
        ...
        <motion.button
          ...
          className="w-full bg-gradient-to-r from-pink-500 via-purple-600 to-indigo-500 text-white font-semibold py-2 cursor-pointer rounded shadow-md flex items-center justify-center"
        >
          {isLoading ? (
            <motion.span
        ...
        <div className="mt-4">
          ...
          <div className="flex flex-col gap-3">
            <motion.button
              ...
              whileHover={{ scale: 1.05 }}
              className="w-full flex items-center justify-center will-change-transform gap-2 px-4 py-2 cursor-pointer bg-white/10 hover:bg-white/20 border border-white/30 rounded-full text-white transition"
            >
            ...
            <motion.button
              ...
              whileHover={{ scale: 1.05 }}
              className="w-full flex items-center justify-center will-change-transform cursor-pointer gap-2 px-4 py-2 bg-white/10 hover:bg-white/20 border border-white/30 rounded-full text-white transition"
            >
